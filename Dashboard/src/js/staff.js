...
const owners = [
    {
        "id": "489464222720458762",
        "post": "Bot Owner",
        "GHURL": "https://github.com/3USAxSNIPER",
    }
]
...
for (let indexOne = 0; indexOne < owners.length; indexOne++) {
    ...
    $.getJSON(API + elementOwners.id)
        .then(output => {
            ...
            const ownerList = "<div id='trigger' class='card' style='margin: 15px;'><div class='banner'><img src='" + output.url + "'></div></br></br></br></br><h2 class='name'>" + output.username + "</h2><div class='title'><h1 id='trigger2' style='font-size: 26px; color: #ffffff;'>" + elementOwners.post + "</h2></div><div class='actions'><div class='follow-btn' style='margin-bottom: 5px;'><a href='" + elementOwners.GHURL + "' target='_blank'><button style='color: #010000;'>GitHub</button></a></div><div class='follow-btn'><a href='"
